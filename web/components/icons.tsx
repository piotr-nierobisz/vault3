// Shared icon set: currentColor stroke glyphs matching lucide geometry
// (visual parity without importing lucide-react). Import the named *Icon
// components; never inline SVGs in a view. Size and colour via className
// (e.g. "h-4 w-4 text-accent").
...
export const SparkleIcon = ({ className }: IconProps) => (
  <Icon className={className}>
    <path d="M12 3l1.9 5.8L20 10.7l-5 3.9 1.7 6.1L12 17l-4.7 3.7L9 14.6l-5-3.9 6.1-.9z" />
  </Icon>
);
